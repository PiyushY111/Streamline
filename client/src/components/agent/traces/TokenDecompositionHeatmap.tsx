      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex justify-between text-xs mb-1">
            ...
            <span className="font-mono text-slate-500">
              {costDecomposition.systemPromptTokens} tokens
            </span>
          </div>
          <div className="h-2.5 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
            <div
              ...
              style={{
                width: `${Math.min(
                  (costDecomposition.systemPromptTokens / (totalTokens || 1)) * 100,
                  100
                )}%`,
              }}
            />
        ...
        <div>
          <div className="flex justify-between text-xs mb-1">
            ...
            <span className="font-mono text-slate-500">
              {costDecomposition.memoryContextTokens} tokens
            </span>
          </div>
          <div className="h-2.5 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
            <div
              ...
              style={{
                width: `${Math.min(
                  (costDecomposition.memoryContextTokens / (totalTokens || 1)) * 100,
                  100
                )}%`,
              }}
            />
        ...
        <div>
          <div className="flex justify-between text-xs mb-1">
            ...
            <span className="font-mono text-slate-500">
              {costDecomposition.historyTokens} tokens
            </span>
          </div>
          <div className="h-2.5 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
            <div
              ...
              style={{
                width: `${Math.min(
                  (costDecomposition.historyTokens / (totalTokens || 1)) * 100,
                  100
                )}%`,
              }}
            />
        ...
        <div>
          <div className="flex justify-between text-xs mb-1">
            ...
            <span className="font-mono text-slate-500">
              {costDecomposition.completionTokens} tokens
            </span>
          </div>
          <div className="h-2.5 rounded-full bg-slate-100 dark:bg-slate-800 overflow-hidden">
            <div
              ...
              style={{
                width: `${Math.min(
                  (costDecomposition.completionTokens / (totalTokens || 1)) * 100,
                  100
                )}%`,
              }}
            />
