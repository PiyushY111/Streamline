    ...
    <header className="h-16 shrink-0 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-[#0D1322]/80 backdrop-blur-xl px-6 flex items-center justify-between sticky top-0 z-20 transition-colors duration-200">
      ...
      <div className="relative">
        <button
          ...
          aria-label="Filter workspace account"
        ...
        {isAccountOpen && (
          <div
            className="absolute left-0 mt-2 w-64 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-2 shadow-xl z-50 animate-in fade-in slide-in-from-top-2 duration-150"
            role="listbox"
          >
      ...
      <div className="flex items-center space-x-3">
        ...
        <button
          onClick={handleSync}
          disabled={isSyncing}
          aria-label="Trigger incremental sync"
        ...
        <div className="relative">
          ...
          {isUserMenuOpen && (
            <div
              className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-2 shadow-xl z-50 animate-in fade-in slide-in-from-top-2 duration-150 space-y-1"
              role="menu"
            >
