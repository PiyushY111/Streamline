              ...
              >
                ...
                <div className="flex items-start space-x-4 flex-1 min-w-0">
                  ...
                  <div className="space-y-2 flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-3 text-xs text-slate-500 dark:text-slate-400 flex-wrap gap-y-1.5">
                      {acc.status === 'error' ? (
                        <div className="flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-600 dark:text-amber-400 font-bold text-[11px]">
                          <AlertCircle className="w-3.5 h-3.5" />
                          <span>Action Required: Token Revoked</span>
                        </div>
                      ) : (
                ...
                <div className="flex items-center space-x-2 shrink-0 self-end md:self-auto border-t md:border-t-0 pt-3 md:pt-0 border-slate-200 dark:border-slate-800/80 w-full md:w-auto justify-end">
                  {acc.status === 'error' && (
                    <button
                      onClick={handleConnectGoogle}
                      className="px-3.5 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold transition-all flex items-center space-x-1.5 shadow-md shadow-amber-500/20"
                      title="Re-authorize this Google account"
                    >
                  ...
                  <button
                    ...
                    disabled={isSyncingThis || acc.status === 'error'}
