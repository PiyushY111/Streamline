...
import type { SwarmSubTaskData } from '@/components/agent/ReasoningDAGVisualizer';

const ReasoningDAGVisualizer = dynamic(
  () => import('@/components/agent/ReasoningDAGVisualizer').then((mod) => mod.ReasoningDAGVisualizer),
  {
    ssr: false,
...
export default function AgentStudioPage() {
  ...
  return (
    <SectionErrorBoundary sectionName="Agent Copilot">
