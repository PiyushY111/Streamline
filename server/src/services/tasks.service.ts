...
export class TasksService {
  ...
  async createTask(userId: string, data: {
    ...
    return tasksRepository.create({
      ...
      estimatedMinutes: data.estimatedMinutes !== undefined && data.estimatedMinutes !== null ? Number(data.estimatedMinutes) : null,
  ...
  async updateTask(id: string, userId: string, data: Partial<{
    ...
    const updatePayload: UpdateTaskInput = {
      ...
      estimatedMinutes: data.estimatedMinutes !== undefined ? (data.estimatedMinutes !== null ? Number(data.estimatedMinutes) : null) : undefined,
    };
